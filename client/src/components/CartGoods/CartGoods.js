...
import Hamburger6 from '../../assets/image/Rectangle 6.png'
import Hamburger8 from '../../assets/image/Rectangle 8.png'
import Hamburger10 from '../../assets/image/Rectangle 10.png'
import Hamburger12 from '../../assets/image/Rectangle 12.png'
      ...
      <div className="cart-goods">
        <div className="cart-goods__elem">
          <div className="cart-goods__image-zone">
            <img className="cart-goods__picture" src={Hamburger6} />
          </div>
          ...
          <div className="cart-goods__action">
            ...
            <div className="cart-goods__select">
              <span className="cart-goods__reveal">1</span>
              <div className="cart-goods__change-select">
                <button className="cart-goods__btn-change"><img src={AngleUp} alt="angle-up" /></button>
                <button className="cart-goods__btn-change"><img src={AngleDown} alt="angle-down" /></button>
              </div>
            </div>
        ...
        <div className="cart-goods__elem">
          <div className="cart-goods__image-zone">
            <img className="cart-goods__picture" src={Hamburger8} />
          </div>
          <div className="cart-goods__desc">
            <h4 className="cart-goods__h4">Бургер з індички</h4>
            <span className="cart-goods__text">Бургер с куриной котлетой и нежной булочкой.</span>
          </div>
          <div className="cart-goods__action">
            <span className="cart-goods__cost">30 грн</span>
        ...
        <div className="cart-goods__elem">
          <div className="cart-goods__image-zone">
            <img className="cart-goods__picture" src={Hamburger10} />
          </div>
          <div className="cart-goods__desc">
            <h4 className="cart-goods__h4">Бургер з яловичини</h4>
            <span className="cart-goods__text">Бургер с куриной котлетой и нежной булочкой.</span>
          </div>
          <div className="cart-goods__action">
            <span className="cart-goods__cost">30 грн</span>
        ...
        <div className="cart-goods__elem">
          <div className="cart-goods__image-zone">
            <img className="cart-goods__picture" src={Hamburger12} />
          </div>
          <div className="cart-goods__desc">
            <h4 className="cart-goods__h4">Бургер зі свинини</h4>
            <span className="cart-goods__text">Бургер с куриной котлетой и нежной булочкой.</span>
          </div>
          <div className="cart-goods__action">
            <span className="cart-goods__cost">30 грн</span>
