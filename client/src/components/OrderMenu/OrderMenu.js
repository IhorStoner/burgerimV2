    ...
    return (
        <React.Fragment>
          <div className="order-menu">
            <a href="#" className="order-menu__link">
                ...
                <span className="order-menu__span">Бургеры</span>
            </a>
            <a href="#" className="order-menu__link">
                <svg width="264" height="97" viewBox="0 0 264 97" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path className="order-menu__bg" d="M252.037 0H246.055H17.9447H11.9631C11.9631 6.627 6.60663 12 0 12V17.5V78.5V85C6.60663 85 11.9631 90.373 11.9631 97H17.9447H246.055H252.037C252.037 90.373 257.393 85 264 85V78.5V17.5V12C257.393 12 252.037 6.627 252.037 0Z" fill="#6A111C"/>
                ...
                <span className="order-menu__span">Сэндвичи</span>
            </a>
            <a href="#" className="order-menu__link">
                <svg width="264" height="97" viewBox="0 0 264 97" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path className="order-menu__bg" d="M252.037 0H246.055H17.9447H11.9631C11.9631 6.627 6.60663 12 0 12V17.5V78.5V85C6.60663 85 11.9631 90.373 11.9631 97H17.9447H246.055H252.037C252.037 90.373 257.393 85 264 85V78.5V17.5V12C257.393 12 252.037 6.627 252.037 0Z" fill="#6A111C"/>
                ...
                <span className="order-menu__span">Гарниры</span>
            </a>
            <a href="#" className="order-menu__link">
                <svg width="264" height="97" viewBox="0 0 264 97" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path className="order-menu__bg" d="M252.037 0H246.055H17.9447H11.9631C11.9631 6.627 6.60663 12 0 12V17.5V78.5V85C6.60663 85 11.9631 90.373 11.9631 97H17.9447H246.055H252.037C252.037 90.373 257.393 85 264 85V78.5V17.5V12C257.393 12 252.037 6.627 252.037 0Z" fill="#6A111C"/>
                ...
                <span className="order-menu__span">Напитки</span>
            </a>
            <a href="#" className="order-menu__link">
                <svg width="264" height="97" viewBox="0 0 264 97" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path className="order-menu__bg" d="M252.037 0H246.055H17.9447H11.9631C11.9631 6.627 6.60663 12 0 12V17.5V78.5V85C6.60663 85 11.9631 90.373 11.9631 97H17.9447H246.055H252.037C252.037 90.373 257.393 85 264 85V78.5V17.5V12C257.393 12 252.037 6.627 252.037 0Z" fill="#6A111C"/>
                ...
                <span className="order-menu__span">Акции</span>
            </a>
          </div>
        </React.Fragment>
    )
